...
const MainContent = () => {
  ...
  const direction = windowWidth < 1194 ? 'column' : 'column-reverse';
      ...
      <div className={classes.content_cards_block}>
        <div className={classes.cards_block}>
          <FlexCard
            direction={'column'}
            image_src={reason1}
            card_title={'Достопримечательности'}
            card_subtitle={
              'Футуристический город посреди степи — левый берег, олицетворяющий техногенное будущее.'
            }
          />
          <FlexCard
            direction={'column'}
            image_src={reason2}
            card_title={'Гостеприимство'}
            card_subtitle={
        ...
        <div className={classes.cards_block}>
          <FlexCard
            direction={direction}
            image_src={reason3}
            card_title={'Самый большой шатёр в мире'}
            card_subtitle={
              'ТРЦ Хан Шатыр является первым и единственным лайфстайл-центром, который объединяет шопинг и развлечения мирового уровня под одной крышей.'
            }
          />
          <FlexCard
            direction={'column'}
            image_src={reason4}
            card_title={'Самая большая опера'}
            card_subtitle={
        ...
        <div className={classes.cards_block}>
          <FlexCard
            direction={'column'}
            image_src={reason5}
            card_title={'Уникальная архитектура'}
            card_subtitle={
